...
// Bot generates furry meme
module.exports = class FurryBot {
    ...
    constructor(webhooks) {
        ...
        let bookContent = fs.readFileSync('Furry.txt','utf8')
        ...
        fs.writeFileSync('furry-output.json', outmsg, 'utf8')
        console.log("FurryBot dictionary loaded.")
